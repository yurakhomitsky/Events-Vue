<template>
  <div>
    ...
    <form @submit.prevent="createEvent">
      ...
      <BaseButton :disabled="$v.$anyError" buttonClass="-fill-gradient" type="submit">Submit</BaseButton>
...
export default {
  ...
  methods: {
    createEvent() {
      this.$v.$touch(); // mark every controll as touched
      if (!this.$v.$invalid) {
        // if formGroup is not invalid
        this.$store
